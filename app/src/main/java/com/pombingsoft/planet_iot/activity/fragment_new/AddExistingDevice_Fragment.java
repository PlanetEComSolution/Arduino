...
public class AddExistingDevice_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_add_existing_device, container, false);
        myContext = getActivity();
        utill = new UTIL(myContext);

        getActivity().setTitle("Add Existing Device");

        Uid = UTIL.getPref(myContext, UTIL.Key_UserId);

        edt_DeviceId =rootView. findViewById(R.id.edt_DeviceId);
        edt_device_password =rootView. findViewById(R.id.edt_device_password);
        btn_add_device =rootView. findViewById(R.id.btn_add_device);
