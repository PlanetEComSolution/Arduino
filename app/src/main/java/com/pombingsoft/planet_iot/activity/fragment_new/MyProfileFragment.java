...
import com.pombingsoft.planet_iot.activity.ChangePasswordActivity;
import com.pombingsoft.planet_iot.activity.UpdateProfileActivity;
...
/*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myContext = MyProfileFragment.this;
...
*/
    ...
    private void init_views(View rootView) {
        ...
        Text_Mobile =rootView. findViewById(R.id.Text_Mobile);
        Text_Gender = rootView.findViewById(R.id.Text_Gender);
        Text_Password = rootView.findViewById(R.id.Text_Password);
